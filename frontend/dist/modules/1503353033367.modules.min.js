...
(function () {
    angular.module('NipCentral').controller('LigacaoCtrl', ['$scope', '$rootScope', 'LigacaoService', 'searchFilter', function ($scope, $rootScope, LigacaoService, searchFilter) {
        $scope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
            $scope.state = toState.name;
        });
    }]).controller('LigacaoPesquisaCtrl', ['$scope', '$rootScope', '$state', 'LigacaoService', 'searchFilter', 'ProgressBarsStorage', function ($scope, $rootScope, $state, LigacaoService, searchFilter, ProgressBarsStorage) {
    ...
    }]).controller('LigacaoDetalhesCtrl', ['$scope', '$rootScope', '$stateParams', function ($scope, $rootScope, $stateParams) {
